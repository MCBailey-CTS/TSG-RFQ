<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditQuote.aspx.cs" Inherits="RFQ.EditQuote" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table id="quoteTable" style="width: 1000px;">
        ...
        <tr>
            <td class="ui-widget">Process: </td><td><asp:DropDownList ID="ddlProcess" runat="server" CssClass="ui-widget"></asp:DropDownList><asp:Label ID="lblProcess" runat="server" CssClass="ui-widget"></asp:Label></td>
        ...
        <tr>
            <td class="ui-widget">Blank Width (in): </td><td><asp:TextBox ID="txtBlankWidthIn" runat="server" CssClass="ui-widget" onkeyup="blankWidthChange()"></asp:TextBox></td>
            <td class="ui-widget">Blank Width (mm): </td><td><asp:TextBox ID="txtBlankWidthMm" runat="server" CssClass="ui-widget"></asp:TextBox></td>
            <td class="ui-widget">Blank Pitch (in): </td><td><asp:TextBox ID="txtBlankPitchIn" runat="server" CssClass="ui-widget" onkeyup="blankPitchChange()"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="ui-widget">Blank Pitch (mm): </td><td><asp:TextBox ID="txtBlankPitchMm" runat="server" CssClass="ui-widget"></asp:TextBox></td>
            <td class="ui-widget">Mat'l Thk (in): </td><td><asp:TextBox ID="txtMaterialThkIn" runat="server" CssClass="ui-widget" onkeyup="matThicknessChange()"></asp:TextBox></td>
            <td class="ui-widget">Mat'l Thk (mm): </td><td><asp:TextBox ID="txtMaterialThkMm" runat="server" CssClass="ui-widget"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="ui-widget">Die size F-B (in): </td><td><asp:TextBox ID="txtFBIn" runat="server" CssClass="ui-widget" onkeyup="dieFBChange()"></asp:TextBox></td>
            <td class="ui-widget">Die size F-B (mm): </td><td><asp:TextBox ID="txtFBMm" runat="server" CssClass="ui-widget"></asp:TextBox></td>
        ...
        <tr>
            <td class="ui-widget">Die size L-R (mm): </td><td><asp:TextBox ID="txtLRMm" runat="server" CssClass="ui-widget"></asp:TextBox></td>
            <td class="ui-widget">Shut Height (in): </td><td><asp:TextBox ID="txtShutIn" runat="server" CssClass="ui-widget" onkeyup="shutHeightChange()"></asp:TextBox></td>
            <td class="ui-widget">Shut Height (mm): </td><td><asp:TextBox ID="txtShutMm" runat="server" CssClass="ui-widget"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="ui-widget">Mat'l Type: </td><td><asp:TextBox ID="txtMaterialType" runat="server" CssClass="ui-widget"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td class="ui-widget">Country of Orign: </td><td><asp:DropDownList ID="ddlCountry" runat="server" CssClass="ui-widget"></asp:DropDownList><asp:Label ID="lblCountry" runat="server" CssClass="ui-widget"></asp:Label></td>
        </tr>
        <tr>
            <td class="ui-widget">Job Number: </td><td><asp:TextBox ID="txtJobNumber" runat="server" CssClass="ui-widget"></asp:TextBox></td>
            <td class="ui-widget">Shipping Location</td><td><asp:TextBox ID="txtShippingLocation" runat="server" CssClass="ui-widget"></asp:TextBox></td>
            <td class="ui-widget"><asp:Label ID="lblTSGQuoting" runat="server"></asp:Label></td><td><asp:DropDownList ID="ddlTSGCompanyQuoting" runat="server"></asp:DropDownList></td>
        </tr>
        <tr class="blank_row">
    ...
    <br />
        <br />
          <br />
         <br />
<%--    <asp:Button ID="btnFinalize" CssClass="ui-widget mybutton" runat="server" OnClick="btnFinalize_Click" UseSubmitBehavior="false"  Text="Finalize" tabindex="-1" OnClientClick="if ( !confirm('Are you sure you want to Finalize this quote? ')) return false;" />--%>
    ...
    return confirm("Are you sure you want to Finalize this quote?");
        }
